if(global.tutorialStage <= 1) {
	...
	// Tutorial
	// Left Movement
	if(global.tutorialStage == 2 && keyboard_check_pressed(ord("A"))) {
		global.tutorialStage += 1;
	}
	
	// Right Movement
	if(global.tutorialStage == 3 && keyboard_check_pressed(ord("D"))) {
		global.tutorialStage += 1;
	}
	
	// Jump Movement
	if(global.tutorialStage == 4 && keyboard_check_pressed(vk_space)) {
		global.tutorialStage += 1;
	}
